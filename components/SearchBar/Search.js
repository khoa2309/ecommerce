...
export default function Search() {
    ...
    return (
        <div className={`md:search_pc hidden`}>
            ...
            <div className="border-l-[1px] border-solid border-border_white pl-6 cursor-pointer h-full items-center md:flex hidden">
                <span className="text-[1.4rem] text-gray mr-[1.5rem]">
                    Trong shop
                </span>
            </div>
            <button className="bg-primary border-none h-[3.4rem] rounded-[0.3rem] w-[6rem] outline-none mr-[0.3rem] flex justify-center items-center hover:bg-blue-700">
                <FontAwesomeIcon
                    icon={faSearch}
